...
public class class_barcode_intentintegrator {

	public static final int REQUEST_CODE = 0x0000c0de; // Only use bottom 16
														// bits
	private static final String TAG = class_barcode_intentintegrator.class.getSimpleName();
	...
	public class_barcode_intentintegrator(Activity activity) {
	 ...
	 *         else an {@link class_barcode_intentresult} containing the result of the scan.
	 *         If the user cancelled scanning, the fields will be null.
	 */
	public static class_barcode_intentresult parseActivityResult(int requestCode,
		...
		if (requestCode == REQUEST_CODE) {
			if (resultCode == Activity.RESULT_OK) {
				...
				return new class_barcode_intentresult(contents, formatName);
			}
			return new class_barcode_intentresult("","");
		}
		return null;
	}
