...
public class orders_manager extends class_activity_extends {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SimpleCursorAdapter Adapt_status = new SimpleCursorAdapter(
        ...
        SimpleCursorAdapter Adapt_categoryes = new SimpleCursorAdapter(
        ...
        cursor_it_t = database.query("items_type",
                new String[]{"_id", "name"}, null, null, null, null, "name");
        SimpleCursorAdapter Adapt_items_type = new SimpleCursorAdapter(
